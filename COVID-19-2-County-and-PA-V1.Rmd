...
sprintf('Acutal new case count for %s was %.2f',PA.verify.dat$Date[1],PA.verify.dat$new.cases[1])
sprintf('Predicted new case count for %s was %.2f',PA.verify.dat$Date[1],prediction[1])
sprintf('Acutal new case count for %s was %.2f',PA.verify.dat$Date[2],PA.verify.dat$new.cases[2])
sprintf('Predicted new case count for %s was %.2f',PA.verify.dat$Date[2],prediction[2])
sprintf('Acutal new case count for %s was %.2f',PA.verify.dat$Date[3],PA.verify.dat$new.cases[3])
sprintf('Predicted new case count for %s was %.2f',PA.verify.dat$Date[3],prediction[3])
```
